...
then finally I lost patience, couldn't read anymore.

Here's a little self-justification, there's another factor causing this
result, which is English is a second language for me, and I was not that skilled
...
That's how things started, and I felt frustrated in the following years until
now, I realized no need to feel in that way back then, it just wasn't the right
time for me to read the book, because I didn't truly understand the value of
those low level things at the moment. After years of working, tinkering with
operating system and softwares, there are so many questions accumulated in my
head without answers, and I can sense I need some fundamental knowledge.
The reading experience this time is a totally different story, it feels like a
breeze, an enjoyable journey, full of "Aha!" moments and smiles.

The most important thing I got from the book is that the low level system is
being demystified to me. It also cured my frustration and anxiety for facing
that blackbox. It gives me superman's x-ray vision, let me look inside the
...
what it really is. Another "Aha!" is about the dynamic linker "ld-linux.so", which
I already used a couple of times for converting my VPS into Arch Linux, which is
after deleting the old system, I need to invoke `ld-linux.so` specifically to
initialize the new system with command:
...
good old times, it was more than a decade ago as I remember,
...
this fancy term made the computer system so mystery to me at that moment.
